...
import {
  ...
  Laptop,
  Cpu,
  // Additional icons for full coverage (auditoria completa de ícones)
  Heart,
  Newspaper,
  Rocket,
  Smartphone,
...
const IONICONS_MAP: Record<string, React.ComponentType<any>> = {
  ...
  "home-outline": Home,
  // Auditoria completa de ícones — adicionados conforme uso real no app
  "heart": Heart,
  "heart-outline": Heart,
  "newspaper": Newspaper,
  ...
  "scale": Scale,
  "scale-outline": Scale,
  // Auditoria final — variantes "-outline" detectadas
...
const MCI_MAP: Record<string, React.ComponentType<any>> = {
  ...
  // Auditoria — adicionados conforme uso dinâmico
  "arm-flex": Dumbbell,
  "dumbbell": Dumbbell,
  "weight": Weight,
  "scale-bathroom": Scale,
  "meditation": Brain,
  "head-lightbulb": Lightbulb,
  "lightning-bolt": Zap,
  "cash-multiple": Coins,
  "home-variant": Home,
  "bike": Bike,
  ...
  "pencil": Pencil,
  "heart": Heart,
  // Auditoria final — nomes Ionicons usados como MCI (TIER_THEME etc.)
  "diamond": Gem,
  "medal": Medal,
  "star": Star,
  "ribbon": Award,
